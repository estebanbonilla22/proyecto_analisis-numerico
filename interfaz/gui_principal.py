...
class App:
    def __init__(self, root: tk.Tk):
        ...
        self.funciones = {
            "Ejercicio 2: E(x) = x^3 - 6x^2 + 11x - 6.5": eficiencia_e,
            "Ejercicio 1: T'(λ) (opcional)": derivada_t,
        }
    ...
    def _build_input_panel(self) -> None:
        ...
        ttk.Button(frame, text="Calcular", command=self.calcular).grid(row=4, column=0, columnspan=2, padx=6, pady=6, sticky="we")
        ttk.Button(frame, text="Limpiar", command=self.limpiar).grid(row=4, column=2, columnspan=2, padx=6, pady=6, sticky="we")
